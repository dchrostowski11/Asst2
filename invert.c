...
struct node *sortedInsert(struct node *newNode, struct node *head){
...
int main(int argc, char **argv){
	...
	//	printf("malloc count:%d\n", malloc_count);
		...
		int len = ((char)sizeof(str) * ORIGINAL_SIZE);
		printf("len = %d\n", len);
		/*if(malloc_count == (sizeof(str) * ORIGINAL_SIZE)){
	...
	*/
	...
	//	printf("%s\n", word);
		...
		list = sortedInsert(newNode, list);
